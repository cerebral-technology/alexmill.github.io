...
$$ = \sum_{n=-\infty}^\infty  \Large( a_n \cos(2\pi nt/T) + b_n \sin(2\pi nt/T) \Large) + i \Large( a_n \sin(2\pi nt/T) - b_n \cos(2\pi nt/T) \Large)  $$
